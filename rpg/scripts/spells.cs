...
%curIndex = 1;
%key = "channelheat";
$Spell::keyword[%curIndex] = %key;
$Spell::index[channelheat] = 1;
$Spell::name[%curIndex] = "Channel Heat";
$Spell::description[%curIndex] = "Radiates heat directly to the target's body at short range. Deals mild damage.";
$Spell::delay[%curIndex] = 0.25;
$Spell::recoveryTime[%curIndex] = 3;
$Spell::damageValue[%curIndex] = "10";
$Spell::LOSrange[%curIndex] = 20;
$Spell::manaCost[%curIndex] = 2;
$Spell::startSound[%curIndex] = LaunchFB;
$Spell::endSound[%curIndex] = NoSound;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = 10;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;

%curIndex = 2;
%key = "firewall";
$Spell::keyword[%curIndex] = %key;
$Spell::index[firewall] = 2;
$Spell::name[%curIndex] = "Wall of Fire";
$Spell::description[%curIndex] = "Creates a wall of fire that lasts for a brief time, dealing damage to anyone standing on it.";
$Spell::delay[%curIndex] = 1;
$Spell::recoveryTime[%curIndex] = 10;
$Spell::damageValue[%curIndex] = "35";
$Spell::LOSrange[%curIndex] = 50;
$Spell::manaCost[%curIndex] = 7;
$Spell::startSound[%curIndex] = ActivateAR;
$Spell::endSound[%curIndex] = LaunchFB;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = 55;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;
...
%key = "fireball";
$Spell::keyword[%curIndex] = %key;
$Spell::index[fireball] = 3;
$Spell::name[%curIndex] = "Fireball";
$Spell::description[%curIndex] = "A pea-sized projectile is launched that explodes into a hellish ball of fire at a desired point.";
$Spell::delay[%curIndex] = 0.5;
$Spell::radius[%curIndex] = 10;
$Spell::recoveryTime[%curIndex] = 14;
$Spell::damageValue[%curIndex] = "90";
$Spell::LOSrange[%curIndex] = 80;
$Spell::manaCost[%curIndex] = 10;
$Spell::startSound[%curIndex] = ActivateAR;
$Spell::endSound[%curIndex] = ExplodeLM;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = 90;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;
...
%key = "combust";
$Spell::keyword[%curIndex] = %key;
$Spell::index[combust] = 4;
$Spell::name[%curIndex] = "Combust";
$Spell::description[%curIndex] = "The target is set ablaze. They take burn damage over time. Water spells, including offensive ones, will cancel this effect.";
$Spell::delay[%curIndex] = 0.75;
$Spell::recoveryTime[%curIndex] = 14;
$Spell::damageValue[%curIndex] = "65";
$Spell::LOSrange[%curIndex] = 40;
$Spell::manaCost[%curIndex] = 10;
$Spell::startSound[%curIndex] = LaunchFB;
$Spell::endSound[%curIndex] = NoSound;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = 65;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;
...
%key = "heatmetal";
$Spell::keyword[%curIndex] = %key;
$Spell::index[heatmetal] = 5;
$Spell::name[%curIndex] = "Heat Metal";
$Spell::description[%curIndex] = "A controversial spell in the Invoker community, Heat Metal works similarly to Flame Weapon, except the metal is directly attacked with heat energy instead of properly bonded with Earth affinity. This spell heats the target's armor and weapon, causing scalding burns and possibly causing them to drop it. Does not work on wooden weapons such as bows and clubs. If the weapon isn't heated or there is no weapon to heat, the spell does less damage.";
$Spell::delay[%curIndex] = 2;
$Spell::recoveryTime[%curIndex] = 20;
$Spell::damageValue[%curIndex] = "170";
$Spell::LOSrange[%curIndex] = 50;
$Spell::manaCost[%curIndex] = 14;
$Spell::startSound[%curIndex] = LaunchFB;
$Spell::endSound[%curIndex] = NoSound;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = 170;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;
...
$Spell::keyword[%curIndex] = %key;
$Spell::index[dbf] = 6;
$Spell::name[%curIndex] = "Delayed Blast Fireball";
$Spell::description[%curIndex] = "Like Fireball, but the projectile remains at the point until the caster detonates (#cast detonate) it. As it stays in place, it accrues more flames from the Elemental Plane of Fire, increasing its damage. The longer the caster allows the Fireball to sit there, the stronger it will be -- to a certain point.";
$Spell::delay[%curIndex] = 0.5;
$Spell::radius[%curIndex] = 10;
$Spell::recoveryTime[%curIndex] = 30;
$Spell::damageValue[%curIndex] = "90";
$Spell::LOSrange[%curIndex] = 40;
$Spell::manaCost[%curIndex] = 10;
$Spell::startSound[%curIndex] = LaunchFB;
...
%key = "fireshield";
$Spell::keyword[%curIndex] = %key;
$Spell::index[fireshield] = %curIndex;
$Spell::name[%curIndex] = "Fire Shield";
$Spell::description[%curIndex] = "For each of the elemental planes, Invokers have created an elemental shield. As well as offering moderate base protection, the shields offer immunity from their respective element.";
$Spell::delay[%curIndex] = 1.5;
$Spell::recoveryTime[%curIndex] = 60;
$Spell::damageValue[%curIndex] = "DEF 180";
$Spell::ticks[%curIndex] = 150;	//5:30 minutes
$Spell::LOSrange[%curIndex] = 40;
$Spell::manaCost[%curIndex] = 15;
$Spell::startSound[%curIndex] = LaunchFB;
$Spell::endSound[%curIndex] = NoSound;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = -10;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[channelheat] = $SkillFireAff;

%curIndex = 8;
%key = "haste";
$Spell::keyword[%curIndex] = %key;
$Spell::index[fireshield] = %curIndex;
$Spell::name[%curIndex] = "Haste";
$Spell::description[%curIndex] = "A most prized and feared transmutation, Haste offers the caster or his target a most brutal advantage in combat by imbuing them with aspects of the Fire Elementals. Land speed is increased half again, and cast and attack times are both halved. Haste is regarded a double-edged sword by non-pyromancers, since the increased speed does not offer any extra durability, and without the fluid body of the Fire Elementals, many elite pyromancers soon died after learning to invoke Haste due to kinetic impact. Those who can cast Nova are truly feared amongst pyromancers; not because of the destructive power the spell bears, but because they mastered the usage of Haste without dying.";
$Spell::delay[%curIndex] = 1;
$Spell::recoveryTime[%curIndex] = 45;
$Spell::manaCost[%curIndex] = 20;
$Spell::startSound[%curIndex] = ActivateAR;
$Spell::endSound[%curIndex] = LaunchFB;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = -30;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;
...
$Spell::keyword[%curIndex] = %key;
$Spell::index[fireshield] = %curIndex;
$Spell::name[%curIndex] = "Nova";
$Spell::description[%curIndex] = "The ultimate display of pyromancy, Nova expels a massive heat wave originating from the caster. The deadly heat incinerates just about everything it touches.";
$Spell::delay[%curIndex] = 1;
$Spell::recoveryTime[%curIndex] = 18;
$Spell::damageValue[%curIndex] = "250";
$Spell::radius[%curIndex] = 30;
$Spell::manaCost[%curIndex] = 20;
$Spell::startSound[%curIndex] = ActivateAR;
$Spell::endSound[%curIndex] = LaunchFB;
$Spell::groupListCheck[%curIndex] = False;
$Spell::refVal[%curIndex] = 250;
$Spell::graceDistance[%curIndex] = 2;
$SkillType[%key] = $SkillFireAff;
