...
function Game::menuRequest(%clientId)
{
	...
	else if(%clientId.choosingAttribs)
	{
	...
	else
	{
		...
		else
		{
			...
			Client::addMenuItem(%clientId, %curItem++ @ "Settings..." , "settings");
			if(!IsDead(%clientId)){
				Client::addMenuItem(%clientId, %curItem++ @ "Belt... (wt:" @ Belt::GetWeight(%clientid) @ ")","viewbelt");
				Client::addMenuItem(%clientId, %curItem++ @ "Skill points..." , "sp");
				Client::addMenuItem(%clientId, %curItem++ @ "Attributes..." , "ap");
			}
...
function processMenuOptions(%clientId, %option)
{
	...
	else if(%opt == "battmsg")
	{
		...
		Client::addMenuItem(%clientId, %curitem++ @ "Chat HUD", "chathud");
		Client::addMenuItem(%clientId, %curitem++ @ "Top Print", "topprint");
		Client::addMenuItem(%clientId, %curitem++ @ "Bottom Print", "bottomprint");
