...
$LocationDesc[$TalismanAccessoryType] = "Neck";
...
$LocationDesc[$DaggerAccessoryType] = "Dagger";
$LocationDesc[$HandsAccessoryType] = "Hands";
$LocationDesc[$FreeAccessoryType] = "Other";
...
$maxAccessory[$FreeAccessoryType] = 256;
...
function GetAccessoryList(%clientId, %type, %filter)
{
	...
	if(IsDead(%clientId) || !fetchData(%clientId, "HasLoadedAndSpawned") || %clientId.IsInvalid || %clientId.choosingRace || %clientId.choosingClass || %clientId.choosingAttribs)
		return "";
